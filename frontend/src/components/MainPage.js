                ...
                <div className="media"><img src="https://res.cloudinary.com/mhmd/image/upload/v1564960395/avatar_usae7z.svg" alt="user" width="50" className="rounded-circle"/>
                  <div className="media-body ml-4">
                    <div className="d-flex align-items-center justify-content-between mb-1">
                      <h6 className="mb-0">{props.contact.fullName}</h6><small className="small font-weight-bold"></small>
                    </div>
...
export default class MainPage extends React.Component {
    ...
    onChangeMessageBody(e) {
     ...
     onSubmit(e) {
      ...
      let sender = this.state.users.find(user => currentUsr.trim() === user.username.trim());
        ...
        <div className="col-5 px-0 messageScroll">
          <div className="bg-white">
            ...
            <div className="bg-gray px-4 py-2 bg-light">
              ...
              <p className="h5 mb-0 py-1 col ">{currentUsr}</p>
              <p className="h7 mb-0 py-1 col float-right"><a href ="#" onClick = {() => {localStorage.setItem("jwtToken", "null"); localStorage.setItem("currentUser", "null"); window.location.reload()}}>Log out</a></p>
              </div>
            </div>
          ...
          <div className="px-4 py-5 chat-box bg-white messageScroll">
          {
            (this.state.currDiscussion.length === 0) ?
                ...
                discussionArray.map(currentMessage => {
                  return (currentMessage.sender.username === currentUsr) ? <OwnMessageBox message = {currentMessage}></OwnMessageBox> : <MessageBox message = {currentMessage} ></MessageBox>
                })
          }
